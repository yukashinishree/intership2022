...
import { PersonalaccountPageForm } from "./personalaccount.page.form"

describe('PersonalaccountPageForm', () =>{

    let personalaccountPageForm:PersonalaccountPageForm;
    let form: FormGroup;
    beforeEach(() =>{
        personalaccountPageForm = new PersonalaccountPageForm(new FormBuilder());
        form = personalaccountPageForm.getForm();
    })
